...
do
  ...
  xdg-icon-resource install --theme hicolor --context mimetypes --size 128 icons/${im}_128x128.png $im
  xdg-icon-resource install --theme hicolor --context mimetypes --size 256 icons/${im}_256x256.png $im
done
